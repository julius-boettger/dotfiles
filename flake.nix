# entry point of my nixos configuration
{
  inputs = {                 
    ...
    # nixpkgs to manage steam version independently
    nixpkgs-steam.url = "github:nixos/nixpkgs?rev=9562d26ef08430dfd399ca44199341daaab33ffc";
    ...
    nix-vscode-extensions = { url = "github:nix-community/nix-vscode-extensions";
      inputs.nixpkgs.follows = "nixpkgs-unstable"; };
    # zen browser
    zenix = { url = "github:anders130/zenix?rev=dcbe7072c2268c388ad1cecdf8bed0d8d7dbc737";
      inputs.nixpkgs.follows = "nixpkgs";
