...
function fish_greeting
    ...
    fastfetch -c /etc/dotfiles/fastfetch/wsl/short.jsonc --color-keys $key_color --color-title $title_color --logo-color-1 $logo_color
    fortune -sn 200
end
...
if status is-interactive
    ...
    alias ls lsd
    alias cat bat
    alias flake-rebuild "cd /etc/dotfiles/nix && sudo nixos-rebuild switch --flake .#wsl"
end